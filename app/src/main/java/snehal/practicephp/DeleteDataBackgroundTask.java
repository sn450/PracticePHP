...
public class DeleteDataBackgroundTask extends AsyncTask<String, Void, String> {

    Context ctx;

    public DeleteDataBackgroundTask(RegisterActivity deleteData) {
        this.ctx = deleteData;
    }

    protected String doInBackground(String... params) {

        String reg_url = "https://snehal-jadhav.000webhostapp.com/delReg.php";
